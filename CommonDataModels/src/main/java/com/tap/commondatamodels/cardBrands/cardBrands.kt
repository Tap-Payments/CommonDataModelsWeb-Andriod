package com.tap.commondatamodels.cardBrands
...
enum class CardBrand(var rawValue: String) {
    ...
    @SerializedName(value = "AMERICAN_EXPRESS", alternate = ["AMEX"])
    ...
    @SerializedName(value = "OMANNET", alternate = ["OMAN_NET"])
    omanNet("OMANNET"),
    ...
    @SerializedName("Ooredoo PAY")
    ooredoo("Ooredoo PAY"),

    @SerializedName("Pay later with Tabby")
    tabbypaylater("Pay later with Tabby"),

    @SerializedName("Pay in Installments with Tabby")
    ...
    @SerializedName("Careem Pay")
    careemPay("Careem Pay"),

    @SerializedName("Buy with Careem Pay")
